...
## محتويات المستودع
* [screenshots/](./screenshots/) : لقطات شاشة لخطوات التحليل.
* [pcap_files/](./pcap_files/) : يحتوي على ملف الـ PCAP الأصلي (مضغوط بكلمة مرور `infected`).
* [README.md](./README.md) : التقرير التحليلي النهائي.
---
 | مسار محلل SOC*
